...
public class IncidentWorker_FloranPasses : IncidentWorker
{
	...
	protected override bool TryExecuteWorker(IncidentParms parms)
	{
		...
		PawnKindDef floran = PawnKindDefOf.Thrumbo;
		...
		SendStandardLetter("LetterLabelFloranPasses".Translate(floran.label).CapitalizeFirst(), "LetterFloranPasses".Translate(thrumbo.label), LetterDefOf.PositiveEvent, parms, pawn);
		return true;
	}
